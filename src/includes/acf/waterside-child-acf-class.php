  ...
  public function acf_init() {
    ...
    acf_add_local_field_group(array(
    	...
    	'fields' => array(
    		...
    		array(
    			'key' => 'field_60068facc5b3b',
    			'label' => 'Floorplans Campaign',
    			'name' => '',
    			'type' => 'tab',
    			'instructions' => '',
    			'required' => 0,
    		...
    		array(
    			'key' => 'field_60069061c5b3c',
    			'label' => 'BCC Email',
    			'name' => 'bcc_email',
    			'type' => 'text',
    			'instructions' => 'Enter an email to BCC when the download all floorplans CTA email is sent.',
    			'required' => 0,
    			'conditional_logic' => 0,
    			'wrapper' => array(
    				'width' => '',
    	...
    	'fields' => array(
    		array(
    			...
    			'layouts' => array(
    				...
    				'layout_5feb8ba161c9d' => array(
    					'key' => 'layout_5feb8ba161c9d',
    					'name' => 'floorplan_sitemap',
    					'label' => 'Floorplan Sitemap',
    					'display' => 'block',
    					'sub_fields' => array(
    						array(
    							'key' => 'field_5feb8bba61c9e',
    							'label' => 'Lakeshore',
    							'name' => 'lakeshore',
    							'type' => 'repeater',
    							'instructions' => '',
